...
public class BattleshipModel {
    ...
    private StealthShip battleship = (StealthShip) new Ship("Battleship",4, new Coordinate(0,0),new Coordinate(0,0));
    ...
    private StealthShip submarine = (StealthShip) new Ship("Submarine",2, new Coordinate(0,0),new Coordinate(0,0));
